            ...
            $(this).each(function () {
                ...
                function showTree(c, t) {
                    ...
                    $.post(o.script, { dir: t }, function (data) {
                        ...
                        bindTree(c);
                        if (o.expandedFolders != null && o.expandedFolders.length > 0) {
                            $(c).find(".directory.collapsed").each(function (i, f) {
                                if ($.inArray($(f).children('a').attr('rel'), $(o.expandedFolders)) != -1) {
                                    showTree($(f), escape($(f).children('a').attr('rel')));
                ...
                function bindTree(t) {
                    $(t).find('LI A').bind(o.folderEvent, function () {
                        if ($(this).parent().hasClass('directory')) {
                            ...
                            $(this).prev().attr('checked', !$(this).prev().prop('checked'));
                            h($(this).attr('rel'));
                        }
                        return false;
                    });
                    $(t).find('LI').bind(o.folderEvent, function () {
                        if ($(this).hasClass('directory')) {
                            if ($(this).hasClass('collapsed')) {
                                ...
                                showTree($(this), escape($(this).find('a').first().attr('rel')));
